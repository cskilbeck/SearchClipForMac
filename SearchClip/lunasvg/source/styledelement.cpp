...
StyledElement::StyledElement(ElementID id) : Element(id) {}
...
Overflow StyledElement::overflow() const {
  ...
  return Parser::parseOverflow(value, parent == nullptr ? Overflow::Visible
                                                        : Overflow::Hidden);
}
...
bool StyledElement::isDisplayNone() const { return display() == Display::None; }
