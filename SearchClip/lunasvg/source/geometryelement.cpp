...
GeometryElement::GeometryElement(ElementID id) : GraphicsElement(id) {}

void GeometryElement::layout(LayoutContext *context,
...
PathElement::PathElement() : GeometryElement(ElementID::Path) {}
...
Path PathElement::path() const { return d(); }

std::unique_ptr<Node> PathElement::clone() const {
  return cloneElement<PathElement>();
}

PolyElement::PolyElement(ElementID id) : GeometryElement(id) {}
...
PolygonElement::PolygonElement() : PolyElement(ElementID::Polygon) {}
...
PolylineElement::PolylineElement() : PolyElement(ElementID::Polyline) {}
...
CircleElement::CircleElement() : GeometryElement(ElementID::Circle) {}
...
EllipseElement::EllipseElement() : GeometryElement(ElementID::Ellipse) {}
...
LineElement::LineElement() : GeometryElement(ElementID::Line) {}
...
RectElement::RectElement() : GeometryElement(ElementID::Rect) {}
