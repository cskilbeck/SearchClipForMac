...
public:
  ...
  virtual std::unique_ptr<LayoutObject>
  getPainter(LayoutContext *context) const = 0;
};
...
public:
  ...
  const PreserveAspectRatio &preserveAspectRatio() const {
    return m_preserveAspectRatio;
  }
  const PatternElement *patternContentElement() const {
